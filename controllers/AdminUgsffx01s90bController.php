<?php
// Thanks!! https://github.com/mpyw-yattemita/php-auth-examples
/**
...
class AdminUgsffx01s90bController extends Controller
{
    ...
    public function verify()
    {
        ...
        if (
            ...
            !is_string($username = $this->verifyActual($_SERVER['PHP_AUTH_DIGEST']))
        ) {
            // 初回時または失敗時には新しくnonceを生成して強制終了
            $nonce = $this->createSession();
