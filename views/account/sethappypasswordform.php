...
<?php $this->setLayoutVar('title', 'Happyログインパスワード設定') ?>
<div class="container">
<div class="row">
<h2>Happyログインパスワード登録</h2>

<form id="sethappypasswordform" class="form-horizontal" action="/happy2/web/account/sethappypasswordauthenticate" method="post" accept-charset="utf-8">
	<input type="hidden" name="_token" value="<?php echo $this->escape($_token); ?>">

	<h4>アカウント連携削除には、Happyのログインパスワード登録が必要です。</h4>
	...
	<div class="form-group">
		<div class="col-sm-offset-3 col-sm-9">
			...
			<input type="submit" class="btn btn-warning btn-lg" value="登録する">
		</div>
	</div>
...
function pageBack(){
	document.getElementById('sethappypasswordform').action = '<?php echo $href_base ?>/account/editProfile';
}
</script>
