...
<?php
	if(!$statuses){
		...
		foreach ($statuses as $status):
			echo $this->render('status/users_small', array('base_url'=> $base_url, 'status' => $status, 'follow_token'=> $follow_token, 'click_token'=> $click_token, 'thisTimeAllClkSum' => $headerUser['thisTimeAllClkSum']));
		endforeach;
	}
?>
