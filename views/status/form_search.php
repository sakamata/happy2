<form class="dis_inline" action="<?php echo $req_base; ?>"  method="post">
	...
	<input type="text" name='searchWord' id="Search_Form" class="input_form_style"  maxlength='20' placeholder="No,ID,名前" <?php if ($selected['searchWord'] =='selected') { echo "value='" .$searchWord. "'" ;}; ?>>
